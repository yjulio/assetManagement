...
def inject_system_settings():
    ...
    try:
        ...
        return dict(
            site_title=settings.get('site_title', {}).get('value', 'Vanuatu Bureau Of Statistics'),
        ...
        return dict(
            site_title='Vanuatu Bureau Of Statistics',
...
@require_group('Admin', 'Asset Officer', 'Finance Officer')
def assets():
    # Allow Admin, Asset Officer, and Finance Officer to view assets
    if not session.get('username'):
            ...
            if 'logo_file' in request.files:
                ...
                if logo_file and logo_file.filename:
                    ...
                    if ext in ['.jpg', '.jpeg', '.png', '.gif', '.svg']:
                        ...
                        flash('Invalid file format. Please upload an image file (jpg, png, gif, svg)', 'warning')
